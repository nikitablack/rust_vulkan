...
pub fn create_screenshot_render_pass(
    device: &ash::Device,
    surface_format: vk::Format,
    depth_format: vk::Format,
    debug_utils_loader: &ash::extensions::ext::DebugUtils,
) -> Result<vk::RenderPass, String> {
    log::info!("creating screenshot render pass");
    ...
    let render_pass = unsafe {
        device
            ...
            .map_err(|_| String::from("failed to create screenshot render pass"))?
    };
    ...
    log::info!("screenshot render pass created");
