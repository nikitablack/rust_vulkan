...
fn main() {
    ...
    let mut make_swapchain_screenshot = false;
    let mut make_standalone_screenshot = false;
    let mut shift_presed = false;
        ...
        match event {
            ...
            Event::MainEventsCleared => {
                ...
                if make_standalone_screenshot {
                    ...
                    if let Err(msg) =
                        vulkan::draw(vk_data_ref, vk_base_ref, make_swapchain_screenshot)
                    {
                        log::error!("{}", msg);
                        vulkan::vulkan_clean(&mut vk_base, &mut vk_data);
                        app_exit = true;
                ...
                make_swapchain_screenshot = false;
                make_standalone_screenshot = false;
            }
            ...
            Event::WindowEvent {
                ...
                shift_presed = modifiers_state.contains(ModifiersState::SHIFT);
            }
            ...
            Event::WindowEvent {
                ...
                VirtualKeyCode::Space => {
                    if shift_presed {
                        make_standalone_screenshot = true;
                    } else {
                        make_swapchain_screenshot = true;
                    }
                }
                _ => (),
            },
